...
/**
  * _binary_search - This function conducts a binary search to find a
  ...
  *
  * Description: This function displays the [sub]array being searched after
  * each change during the binary search process.
  */
...
/**
  * exponential_search - This function employs exponential search
  ...
  * the array during the exponential search process.
  */
